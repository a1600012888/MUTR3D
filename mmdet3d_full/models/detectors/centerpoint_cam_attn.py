...
class CenterPointCamAttn(MVXTwoStageDetector):
    ...
    def extract_img_feat(self, img, img_metas, lidar2img, lidar2cam, cam_intrinsic):
        ...
        if self.with_img_neck:
            img_feats_reshaped = self.img_neck(img_feats_reshaped, lidar2img, lidar2cam, cam_intrinsic)
        return img_feats_reshaped

    def extract_feat(self, points, img, img_metas, lidar2img, lidar2cam, cam_intrinsic):
        """Extract features from images and points."""
        if self.finetune:
            with torch.no_grad():    
                feats = self.extract_img_feat(img, img_metas, lidar2img, lidar2cam, cam_intrinsic)
        else:
            feats = self.extract_img_feat(img, img_metas, lidar2img, lidar2cam, cam_intrinsic)
        return (None, feats)
    ...
    def forward_train(self,
        ...
        img_feats, pts_feats = self.extract_feat(
            points, img=img, img_metas=img_metas, lidar2img=lidar2img, 
            lidar2cam=lidar2cam, cam_intrinsic=cam_intrinsic)
        losses = dict()
    ...
    def simple_test(self, points, img_metas, img=None, lidar2img=None, 
                    lidar2cam=None, cam_intrinsic=None, rescale=False):
    ...
    def aug_test(self, points, img_metas, imgs=None, lidar2img=None, lidar2cam=None, cam_intrinsic=None, rescale=False):
        """Test function with augmentaiton."""
        img_feats, pts_feats = self.extract_feats(points, imgs=imgs, img_metas=img_metas, 
