...
## Provide a implementation for using non-key frames!
...
class NuScenesTrackDatasetNonKeyFrame(Dataset):
    r"""NuScenes Dataset.
    ...
    def get_data_info(self, index):
        ...
        Returns:
            dict: Data information that will be passed to the data \
                ...
                - is_key_frame (float): 0.0: non-key-frame; 1.0: key frame
        ...
        input_dict = dict(
            ...
            is_key_frame=float(info['is_key_frame']), 
            radar=info['radars'],
        )
    ...
    def _format_bbox(self, results, jsonfile_prefix=None):
        ...
        for sample_id, det in enumerate(mmcv.track_iter_progress(results)):
            ...
            is_key_frame = self.data_infos[sample_id]['is_key_frame']
            ...
            for i, box in enumerate(boxes):
                ...
                if np.sqrt(box.velocity[0]**2 + box.velocity[1]**2) > 0.2:
                    if name in [
                        ...
                        attr = NuScenesTrackDatasetNonKeyFrame.DefaultAttribute[name]
                else:
